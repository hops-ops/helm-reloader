...
PACKAGE ?= helm-reloader
XRD_DIR := apis/reloaders
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/reloaders/standard.yaml
...
EXAMPLES := \
    examples/reloaders/minimal.yaml:: \
    examples/reloaders/standard.yaml::
...
render\:%:
	@example="examples/reloaders/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
